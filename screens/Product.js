...
import { Dimensions, StyleSheet, Image, ScrollView, FlatList, TouchableOpacity } from 'react-native';
        ...
        <Block style={styles.product}>
          ...
          <Block flex={false} row margin={[theme.sizes.base, 0]}>
            {product.tags.map(tag => (
              <Text key={`tag-${tag}`} caption gray style={styles.tag}>{tag}</Text>
            ))}
          </Block>
          ...
          <Block>
            ...
            <Block row margin={[theme.sizes.padding * 0, 9, 0]}>
              ...
              <Block
                ...
                style={styles.more}
              >
                <Text gray2>+{product.images.slice(3).length}</Text>
              </Block>
            </Block>
          </Block>
